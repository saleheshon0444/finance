  ...
  return (
    <div className="m-5 bg-white rounded-3xl h- shadow-lg flex flex-col divide-y-2 divide-softBlue/20 p-5 ">
      <div className="flex flex-row justify-between items-center pb-3">
        ...
        <div className="w-[244px] h-[32px] bg-back shadow-inner rounded-full flex flex-row justify-center items-center">
          <input
            type="text"
            placeholder="Search..."
            className="bg-back rounded-full focus:border-back focus:outline-none"
          />
      ...
      <div className="flex flex-row justify-around items-center py-3">
        <p className="font-medium w-28 text-center text-softBlue">ID</p>
        <p className="font-medium w-32 text-center text-softBlue">Name</p>
        <p className="font-medium w-48 text-center text-softBlue">Date</p>
        <p className="font-medium w-64 text-center text-softBlue">Email</p>
        <p className="font-medium w-32 text-center text-softBlue">Status</p>
        <p className="font-medium w-32 text-center text-softBlue">Actions</p>
      </div>
      <div className="flex flex-col justify-around items-center py-3">
